...
def find_contacts_and_vis(sdf_func1, sdf_func2, max_iter=1000, lr=1e-2, n_cand=100, ):
    ...
    # Extra info needed to present the results
...
if __name__ == "__main__":
    ...
    print(plane_sdf(x))
    find_contacts_and_vis(sdf_func1, sdf_func4, max_iter=120, lr=0.1, n_cand=100)
    find_contacts_and_vis(sdf_func3, sdf_func4, max_iter=120, lr=0.1, n_cand=100)
    find_contacts_and_vis(sdf_func2, sdf_func4, max_iter=120, lr=0.1, n_cand=100)
